...
class Endpoint(models.Model):
    ...
    Attributes:
        name: The name of the endpoint, it will be sed in API URL
...
class MLAlgorithmStatus(models.Model):
    ...
    class StatusChoices(models.TextChoices):
        ...
        AB_TESTING = 'ab_testing', 'AB_Testing'

    status = models.CharField(max_length=15, choices=StatusChoices.choices, default=StatusChoices.TESTING)
...
class ABTest(models.Model):
    ...
    parent_mlalgorithm_1 = models.ForeignKey(MLAlgorithm, on_delete=models.CASCADE, related_name="parent_mlagorithm_1")
    parent_mlalgorithm_2 = models.ForeignKey(MLAlgorithm, on_delete=models.CASCADE, related_name="parent_mlagorithm_2")